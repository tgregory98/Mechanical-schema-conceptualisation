...
At this stage I am working on entity resolution, and wrapping the builder classes in a class that optimises depth parameter selection. You can see the current progress of this on the develop branch.
