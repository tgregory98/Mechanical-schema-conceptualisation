...
class ParentSchemaBuilder(SchemaBuilder):
    ...
    WHERE {
        ...
        """
        query_part2 = query_part2 + final_string
...
# sch1 = PairwiseSchemaBuilder("http://dbpedia.org/resource/Television", "http://dbpedia.org/resource/Netflix", ["dct:subject", "skos:broader"])
