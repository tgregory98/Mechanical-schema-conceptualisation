...
commit_cypher_code("MATCH (x) DETACH DELETE (x)")

# sch1 = PairwiseSchemaBuilder("http://dbpedia.org/resource/Television", "http://dbpedia.org/resource/Netflix", filter_set_edges=["dct:subject", "skos:broader"], filter_set_vertices=[])
# sch1.build_at_depth(2)
# sch1.build_at_depth(3)
# sch1.build_at_depth(4)

# sch2a = ParentSchemaBuilder("http://dbpedia.org/resource/Netflix", filter_set_edges=["dct:subject", "skos:broader", "rdf:type"], filter_set_vertices=[])
# sch2a.build_at_depth(2)

# sch2b = ParentSchemaBuilder("http://dbpedia.org/resource/Television", filter_set_edges=["dct:subject", "skos:broader", "rdf:type"], filter_set_vertices=[])
...
# - Update the build_at_depth() strings.
